    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md p-6 rounded-lg shadow-lg">
        ...
        <div className="flex justify-between bg-[#0967D2] text-white text-[13px] px-3 py-2 rounded-[12px]">
          <div>{coverLetters[0].category}</div>
          <div>
            <span>Created:</span>
        ...
        <div className="flex justify-end ">
          <Button className="h-8 border " variant="ghost">
            Copy
          </Button>
        </div>
        ...
        <div className="h-[50vh] overflow-y-auto no-scroll">
          <div className="text-xs">
            ...
            <p className="mt-3">
              ...
              skills and knowledge to your team.
            </p>

            <p>
              In my current role at ProDews, I have successfully collaborated
              with cross-functional teams to deliver exceptional designs that
              prioritize user experience and drive business success. I have also
              actively contributed to the development of the company&apos;s
            ...
            <p>
              ...
              certifications in Product, I believe I have the qualifications and
              expertise to excel in this role. I am proficient in
              industry-standard tools such as Figma and have a deep passion for
              creating seamless products that elevate user satisfaction.
            </p>

            <p>
              I am confident that my skills and experience make me a strong
              candidate for this position. I am eager to bring my creative
              vision and problem-solving abilities to your team and contribute
              to the success of your projects. Thank you for considering my
              application.
            </p>
