      ...
      <DialogContent className="sm:max-w-md p-0 overflow-hidden rounded-lg border shadow-lg cursor-pointer">
        ...
        <div className="p-6 space-y-4">
          <p className="text-sm text-gray-600 text-[12.5px]">
            Start fresh or upload an existing resume, we&apos;ll guide you
            step-by-step to create a polished, professional resume tailored to
            your goals.
          </p>
          ...
          <div className="bg-green-50 rounded-md p-4 flex items-start">
            ...
            <p className="text-xs text-green-700">
              Whichever option you choose, we&apos;ll provide access to expertly
              designed templates to help you craft the perfect resume.
            </p>
          </div>
        </div>
      </DialogContent>
