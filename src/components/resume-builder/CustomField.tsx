  ...
  return (
    <div className="space-y-4 mt-6">
                ...
                <div className="relative bg-white p-4 rounded-lg border border-gray-100 shadow-sm mb-2">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <Button
                      ...
                      variant="ghost"
                      size="icon"
                      className="h-8 w-8 rounded-full text-gray-400 hover:text-gray-700 hover:bg-gray-100 cursor-pointer "
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleCustomFieldValueChange(field.name, e.target.value)
                    }
                  />
                </div>
              </div>
      ...
      <button
        ...
        className="w-full py-2 px-4 border-2 border-dashed border-blue-200 rounded-lg text-blue-600 hover:bg-blue-50 hover:border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-100 transition-all duration-200 flex items-center justify-center space-x-2 cursor-pointer "
      >
        <PlusIcon size={18} />
