...
import { WorkExperienceFormValues } from '@/data/form/props';
                ...
                >
                  {field.value ? (
                    field.value === 'Present' ? (
                      ...
                      format(new Date(field.value as string), 'MMM dd, yyyy')
                    )
                  ) : (
...
export function JobTitleStateFields({
  form,
  index = 0,
...
export function CurrentJobCheckbox({
  form,
  index = 0,
}: WorkExperienceFieldProps) {
