  ...
  return (
    <>
      <div className="bg-gray-900 text-white  p-6  rounded-[12px] relative overflow-hidden">
        <Image
          src="https://res.cloudinary.com/dk5mfu099/image/upload/v1742800571/bg-sub_e0cny4.jpg"
          alt="Overlay Image"
        ...
        {isFree && (
          <div className="mt-6 space-y-4 relative z-10">
            ...
            <p className="text-sm text-gray-400">
              Unlock premium features to boost your job search!
            </p>
        ...
        {!isPremium && !isFree && (
          <div className="mt-6 space-y-4 relative z-10">
            ...
            <p className="text-sm text-gray-400">
              Switch to the annual plan and enjoy exclusive benefits while
              saving more.
            </p>
