...
const NavMobile = ({ isOpen }: NavMobileProps) => {
  return (
    <section
      className="absolute md:hidden flex flex-col items-start justify-start px-2 py-6 top-14 w-full bg-white rounded-[12px] shadow-card transition-all duration-300"
