    ...
    <section className="w-full xl:min-h-screen min-h-full md:h-[1000px] h-full flex flex-col md:justify-end justify-start items-center font-gabarito bg-svg relative px-6 md:pt-0 pt-32">
      <div className="w-full flex flex-col justify-start items-center gap-4">
        ...
        <div className="flex sm:flex-row flex-col justify-center items-center gap-4 w-full">
          <Link
            href={'/waitlist'}
            className="px-6 py-3 rounded-lg sm:text-base text-xs font-normal text-white bg-gradient-to-br from-[#0967D2] to-[#09CBD2] border-0 border-transparent cursor-pointer sm:w-fit w-full outline-none"
          >
            Apply smarter with AI
          </Link>
          <Link
            href={'/waitlist'}
            className="px-6 py-3 rounded-lg sm:text-base text-xs font-normal text-primary bg-transparent border border-primary cursor-pointer sm:w-fit w-full outline-none"
          >
            Generate resume
          </Link>
        </div>
