    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md p-6 rounded-lg">
                <DialogHeader>
                    <DialogTitle className="text-lg font-semibold">Delete resume?</DialogTitle>
                ...
                <div>
                    <p className='text-[13px]'>Are you sure you want to delete this resume? <br />  This action cannot be undone</p>
                </div>
                <div className="mt-6 flex gap-4">
                    <Button variant="outline" className="flex-1 cursor-pointer " onClick={() => onOpenChange(false)}>
                        Cancel
                    </Button>
                    <Button variant="outline" className="flex-1 cursor-pointer bg-[rgba(9,103,210,1)] text-white">
                        Yes, Delete resume
                    </Button>
                </div>
            </DialogContent>
