                    ...
                    <React.Fragment key={index}>
                        {page === '...' ? (
                            ...
                            <button
                                ...
                                className={`pagination-btn ${currentPage === page ? 'active bg-blue-500 text-white w-[33px] p-1 rounded-2xl ' : 'text-gray-700 hover:bg-gray-100 border w-[33px] p-1 rounded-2xl cursor-pointer'
                                    }`}
                            >
                                {page}
                            </button>
