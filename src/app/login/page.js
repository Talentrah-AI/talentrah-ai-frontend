...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-white">
      {/* Left Section */}
      <div className="hidden md:flex flex-1 p-4 flex flex-col justify-between text-white">
      {/* min-h-screen flex flex-col rounded-2xl w-1/2 bg-blue-600 */}
      <div className="bg-login bg-cover rounded-2xl bg-center min-h-screen">

        <div>
          <div className="flex items-center gap-2 mr-0 ml-4 p-4">
          <Image
             src={Talentrah}  
             width={70}
             height={70}
          ...
          <div className="mt-11">
            <h1 className="text-3xl font-bold leading-tight mr-0 ml-4 p-4">
      ...
      {/* Right Section */}
      <div className="w-[600px] flex p-5 flex-col justify-center">
        ...
        <div className="mt-1">
          ...
          <p className="mt-2 font-small text-gray-600">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-2"> 
              <button
                type="button"
                className="w-full flex items-center justify-center gap-2 px-3 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition"
              >
                <img
              ...
              <button
                type="button"
                className="w-full flex items-center justify-center gap-3 px-3 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition"
              >
                <img
