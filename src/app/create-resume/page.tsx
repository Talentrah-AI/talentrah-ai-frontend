...
// import { NextModal } from "../comp/NextModal";
                ...
                <div className="flex">
                    ...
                    <div className="lg:hidden fixed top-0 left-0 right-0 bg-white z-50 border-b">
                        <div className="flex items-center justify-between p-2">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <Button variant="ghost" className="text-gray-600 flex items-center text-[13px] border ">
                                    <Globe />
                                    English
                    ...
                    <div className="hidden lg:flex lg:w-60 lg:flex-col h-full bg-white fixed z-40">
                        ...
                        <nav className="flex-1 space-y-1">
                            ...
                            <Link href="#" className="flex items-center px-3 py-2 text-sm font-medium text-white bg-blue-600 rounded-md w-52 ml-2 ">
                                <Settings className="w-4 h-4 mr-3" />
                                <p className="text-[13px]">Resume Builder</p>
                            </Link>
                        </nav>
                                ...
                                <div className="mt-3 ">
                                    ...
                                    <div className="flex justify-between items-center h-fit mt-4">
                                        <div className="bg-white shadow-md rounded-lg p-1 flex items-center">
                                            ...
                                            <Link className="cursor-pointer" href="/create-cover-letter">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <button className="px-4 py-2 w-[170px] bg-[#0967d2] text-[13px] text-white ml-2 flex items-center gap-3 justify-center cursor-pointer rounded-2xl"
