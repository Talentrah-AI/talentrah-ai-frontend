...
export default function CreateAccountPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Store data in sessionStorage to pass to step 2
    const formData = {
      fullName,
      email,
      phoneNumber: `${countryCode}${phoneNumber}`,
    };
    sessionStorage.setItem('registration_step1', JSON.stringify(formData));
        ...
        <div className="w-full max-w-[558px] max-h-[620.76px] bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center">
          ...
          <form className="w-full space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              ...
              <div
                className={`relative flex items-center w-full max-w-[510px] h-[50px] rounded-[8px] px-3 bg-white text-black ${countryCode || phoneNumber ? "border-black" : "border-gray-200"} border`}
              >
