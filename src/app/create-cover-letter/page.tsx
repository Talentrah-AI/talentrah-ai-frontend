...
import { UserCoverLetter } from "../comp/UserCoverLetter";
                                ...
                                <div className="flex justify-between mt-4 items-center">
                                    ...
                                    <div className="relative inline-flex">
                                        ...
                                        {showCustomizeOptions && (
                                            <div
                                                className="absolute right-full top-0 mr-2 w-[300px] bg-white border border-gray-200 rounded-lg shadow-lg z-50 p-4"
                                            >
