// src/app/(userdashboard)/premium-user-apply/page.tsx
/**
...
function Apply() {
  ...
  const handleOptimizeResume = () => {
    ...
    setTimeout(() => {
      ...
      router.push(`/jobdashboard/resume-optimized?jobTitle=${jobTitle}&company=${company}`);
    }, 2000);
  };

  return (
    <>
      {isOptimizing && <LoadingSpinner message="Optimizing your resume, this might take a few minutes..." />}
      <div className="h-full overflow-y-auto">
        <div className="bg-[#F7F8F9] rounded-[24px] px-6 py-6 max-w-[1300px] w-full mx-auto">
          <div
            className={`w-[1157px] flex flex-col gap-[32px] p-[12px] pt-[12px] pr-[12px] pb-[30px] pl-[12px] rounded-[24px] bg-[#F8F8F8] transition-all duration-200 ${
            ...
            <section className="w-[1133px] flex justify-between">
              <div className="w-[707px] flex flex-col gap-[12px]">
                ...
                <div className="flex items-center justify-center w-[707px] h-[128px] gap-[71px] p-[24px_10px] rounded-[12px] bg-white">
                  <div className="flex items-center">
                    <CircularProgress label="Match score" value={75} color="#2563EB" bgColor="rgba(37, 99, 235, 0.1)" />
                  </div>
                  <div className="flex items-center">
                    <CircularProgress value={70} color="#F97316" bgColor="rgba(249, 115, 22, 0.1)" label="Qualification" />
                  </div>
                  <div className="flex items-center">
                    <CircularProgress value={40} color="#22C55E" bgColor="rgba(34, 197, 94, 0.1)" label="Skills" />
                  </div>
                  <div className="flex items-center">
                    <CircularProgress value={50} color="#06B6D4" bgColor="rgba(6, 182, 212, 0.1)" label="Experience" />
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center justify-center w-[707px] h-[601px] rounded-[12px] bg-[#FFFFFF] gap-4">
                  ...
                  <div className="flex flex-col w-[683px] h-[132px] gap-[10px] p-[14px_10px] rounded-[12px] border-[0.5px] border-[#EFF0F2] border-opacity-50">
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-center gap-2 font-[Gabarito] font-normal text-[12px] leading-[16px] tracking-[0px] text-[#515D68]">
                        ...
                        Your experience in understanding UX principles and accessibility matches the job description.
                      </li>
                      <li className="flex items-center gap-2 font-[Gabarito] font-normal text-[12px] leading-[16px] tracking-[0px] text-[#515D68]">
                        <Image src="/Ellipse.svg" alt="" width={16} height={16} />
                        Your resume includes relevant UI/UX tools like Figma and Adobe XD
                      </li>
                      <li className="flex items-center gap-2 font-[Gabarito] font-normal text-[12px] leading-[16px] tracking-[0px] text-[#515D68]">
                        <Image src="/Ellipse.svg" alt="" width={16} height={16} />
                        Your resume includes relevant UI/UX tools like Figma and Adobe XD
                  ...
                  <div className="flex flex-col w-[683px] h-[132px] gap-[10px] p-[14px_10px] rounded-[12px] border-[0.5px] border-[#EFF0F2] border-opacity-50">
                    <h3 className="flex items-center gap-2 font-[Gabarito] font-normal text-[12px] leading-[16px] tracking-[0px] text-[#90989F]">
                      <Image src="/danger.svg" alt="danger-icon" width={16} height={16} />
                      AREAS TO IMPROVE
                    </h3>
                    <ul className="space-y-3">
                      <li className="flex items-center gap-2 font-[Gabarito] font-normal text-[12px] leading-[16px] tracking-[0px] text-[#515D68]">
                      ...
                      <li className="flex items-center gap-2 font-[Gabarito] font-normal text-[12px] leading-[16px] tracking-[0px] text-[#515D68]">
                        <Image src="/Ellipse.svg" alt="" width={16} height={16} />
                        Your formatting is not fully ATS-compliant (e.g., missing section headings, inconsistent font use).
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="flex flex-col w-[683px] h-[214px] gap-[10px] p-[14px_10px] rounded-[12px] border-[0.5px] border-[#EFF0F2] border-opacity-50">
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-start gap-2 font-[Gabarito] font-normal text-[12px] leading-[16px] tracking-[0px] text-[#515D68]">
                        <Image src="/Ellipse.svg" alt="" width={16} height={16} />
                        <div>
                          <span className="text-black">Sales and Marketing Experience: </span>
                          <span>Your past role in digital marketing is not relevant to this UI/UX role</span>
                        </div>
                      </li>
                      <li className="flex items-start gap-2 font-[Gabarito] font-normal text-[12px] leading-[16px] tracking-[0px] text-[#515D68]">
                        <Image src="/Ellipse.svg" alt="" width={16} height={16} />
                      ...
                      <li className="flex items-start gap-2 font-[Gabarito] font-normal text-[12px] leading-[16px] tracking-[0px] text-[#515D68]">
                        <Image src="/Ellipse.svg" alt="" width={16} height={16} />
                        <div>
                          <span className="text-black">Unnecessary Personal Details: </span>
                          <span>Your resume includes age, marital status, and full address, which are not needed</span>
                        </div>
                      </li>
                    </ul>

                    <div className="flex items-start mt-6 gap-[10px] rounded-[16px] border-[0.5px] p-[15px] bg-[#E6F0FB] border-[#9DC2ED]">
                      <Image src="/information.svg" alt="info" width={20} height={20} />
                      <p className="text-sm text-[#2563EB]">
                        Tip: Removing irrelevant details and restructuring your resume can boost your match score!
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <main className="w-[412px] flex flex-col gap-[12px]">
                <div className="flex items-center gap-[10px] rounded-[12px] border-[0.5px] p-[15px] bg-[#FCEFE6] border-[#F4C19C]">
                  <Image src="/information1.svg" alt="info-circle" width={20} height={20} />
