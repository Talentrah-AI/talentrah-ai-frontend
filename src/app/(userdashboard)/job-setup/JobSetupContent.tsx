...
export default function JobSetupContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      const jobTitle = formData.jobTitles[0];
      const location = formData.locations[0];
      router.push(`/job-matched?showPopup=true&jobTitle=${encodeURIComponent(jobTitle)}&location=${encodeURIComponent(location)}`);
    }, 3000);
  };
        ...
        <div className="bg-[#F7F8F9] rounded-[24px] px-6 py-6 max-w-[1300px] w-full mx-auto">
          <div className="w-full max-w-[1200px]">
            ...
            <p className="text-[12px] text-[#717A84] mb-6">
              Tell us what type of jobs you are looking for, and our AI will find and apply to the best matches for you—automatically!
            </p>
