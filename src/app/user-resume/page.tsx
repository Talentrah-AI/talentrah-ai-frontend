...
import { ChevronDown, Settings, User, Phone, MessageSquare, Plus, Search, Bell, Crown, BriefcaseBusiness, LayoutGrid, Grid2x2, Globe } from "lucide-react";

import { Button } from "@/components/ui/button";
import { useState } from "react";
import { CreateResumeModal } from "../comp/CreateResumeModal";
import { UploadResumeModal } from "../comp/UploadResumeModal";
import { ResumeModal } from "../comp/ResumeModalsOptions";
import { Pagination } from "../comp/Pagination";
// import '../create-resume/noScroll/style.css'
import { toast } from "sonner";
import resume from "../shadcnFolder/resumee/create-resume";

export default function UserResumeData() {
                    ...
                    <div className="flex-1 flex flex-col lg:mt-0 mt-14 lg:ml-60 ">
                        ...
                        <header className="h-14 border-b lg:flex items-center justify-between px-4 bg-white hidden fixed z-50 w-full lg:w-[calc(100%-240px)]">
                            ...
                            <div className="flex items-center space-x-7 text-[13px]">
                                ...
                                <Button variant="ghost" className="text-gray-600 flex items-center text-[13px] h-8 rounded-[10px] border">
                        ...
                        {/* Main Content Area */}
                        <div className="m-auto w-[96%] mt-14 no-top">
                            {/* desktop */}
                            <div className="hidden lg:block">
                                <div className="flex justify-between items-center h-fit mt-3">
                                    <p>My Resumes</p>
                                    <div className="flex items-center">
                                        <Link className="cursor-pointer" href="/cover-letter">
                                            <button className="px-4 py-1.5 text-[13px] text-blue-800 border border-blue-800 rounded-2xl cursor-pointer ">
                                                Generate cover letter
                                            </button>
                                        </Link>
                                        <button className="px-5 py-1.5 text-[13px] bg-[#0967d2] text-white ml-2 flex items-center gap-2 justify-center cursor-pointer rounded-2xl"
                                ...
                                <div className="flex justify-between mt-4 items-center">
                                    ...
                                    <div className="relative">
                                        ...
                                        <button
                                            ...
                                            className="flex gap-2 items-center justify-between px-4 h-10 text-sm text-gray-600 bg-[#F5F7FB] border border-gray-200 rounded-xl hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
                                        >
                            ...
                            <div className="lg:hidden">
                                ...
                                <div className="flex flex-col sm:flex-row flex-wrap gap-3 mt-4 items-center">
                                ...
                                <div className="mt-6">
                                    <div className="flex flex-wrap gap-4">
                                        ...
                                        <Link className="cursor-pointer w-full" href="/cover-letter">
                                ...
                                <div className="space-y-4">
                                    {resume.map(cv => (
                                        <ResumeModal
                                            ...
                                            isOptimized={cv.isOptimized}
                                            isDefault={cv.isDefault}
                                            imageUrl="https://www.myperfectcv.co.uk/wp-content/uploads/2022/08/administrative-assistant-cv.svg"
                                        />
                                    ))}
                                </div>
